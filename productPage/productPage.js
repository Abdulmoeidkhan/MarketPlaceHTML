...
let childItem = {}
childItem.value= JSON.parse(localStorage.getItem("viewProductData"))
...
newModal.setAttribute("id", `myModal${1}`)
...
newModalImg.setAttribute("id", `caption0${1}`)
...
let mainComponent = document.getElementById("cardContainerDynamic")
